...
export default function EnneagramCard({ enneagram }: EnneagramCardProps) {
  ...
  return (
    <div className="flex justify-center items-center gap-4">
      <div className="border border-gray-400 w-full max-w-xs p-4 space-y-4 rounded-xl shadow-xl">
      ...
      <div className="border-2 border-gray-400 w-full min-w-xs max-w-lg p-8 space-y-8 rounded-xl shadow-xl">
      ...
      <div className="border border-gray-400 w-full max-w-xs p-4 space-y-2 rounded-xl shadow-xl">
        <div className="flex flex-col">
